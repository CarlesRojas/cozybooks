    ...
    return (
        ...
        >
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Application</strong> refers to CozyBooks, the software program provided by the Company.
                    </p>
                </li>
                <li>
                    <p>
                        <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                        &quot;Our&quot; in this Agreement) refers to CozyBooks.
                    </p>
                </li>
                <li>
                    <p>
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to CozyBooks, accessible from{" "}
                        <a href="https://www.cozyBooks.app" rel="external nofollow noopener" target="_blank">
                            https://www.cozyBooks.app
                        </a>
                    </p>
                </li>
                <li>
            ...
            <p>
                ...
                mobile device when You go offline, while Session Cookies are deleted as soon as You close Your web browser. You can learn
            ...
            <ul>
                ...
                <li>
                    <p>
                        ...
                        going concern or as part of bankruptcy, liquidation, or similar proceeding, in which Personal Data held by Us about
            ...
            <ul>
                <li>By email: cozybooks@carlesrojas.com</li>
            </ul>
        </main>
    );
};
