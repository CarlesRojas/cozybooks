...
const buttonVariants = cva(
    "focus-scale inline-flex items-center justify-center whitespace-nowrap text-base outline-none font-semibold transition-colors disabled:pointer-events-none disabled:opacity-30",
    {
        variants: {
            variant: {
                default:
